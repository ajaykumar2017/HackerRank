...
public class Determining_DNA_Health {
	...
	public static void main(String[] args) {
		...
		scanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");
		// Second Line-->space-separated strings describing the respective values of
		// genes
		...
		// Third Line-->space-separated integers describing the respective values of
		// health
		...
		scanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");
		// Each of the s subsequent lines describes a DNA strand in the form start end
		// d,
		// denoting that the healthy genes for DNA strand d are g.start.....g.end and
		// their respective
	...
	private static int[] determiningDNAHealth(String[] genElements, int[] healthElements, int s, int[] start, int[] end,
			String[] d) {
